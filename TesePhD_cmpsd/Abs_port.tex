...
\textbf{	Co-orientadores: \quad Doutor Nuno Sérgio Castelo  Branco da Cruz e Doutor Alfredo Pironti}
\smallskip
...
O trabalho desenvolvido para o JT60-SA nesta tese consiste numa série de simulações usando dois controladores diferentes para a forma do plasma e métodos para obter a última superfície fechada de fluxo na presença de distintas perturbações e de uma mudança na referência da forma do plasma assim como a comparação dos resultados obtidos destes dois controladores e  das medidas  da última superfície fechada de fluxo. A implementação destes controladores é  possível por meio dum equilíbrio teórico dado na forma dum modelo linear em espaço de estados do comportamento magnético do tokamak.\smallskip
