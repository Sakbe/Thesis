...
\begin{table}[]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|l|l|}
		\hline
			\rowcolor{color2}
		\multicolumn{9}{|c|}{\textbf{Minor disruption steady state error}}                                                                                                                                                                         \\ \hline
			\rowcolor{color1}
		...
		6 points                                                              & 1           & 5          & 5            & 6            & 1                        & 2                        & 1                        & 2                        \\ \hline
		8 points                                                              & 3           & 2          & 4            & 5            & 4                        & 4                        & 4                        & 4                        \\ \hline
		19 points                                                             & 4           & 4          & 65           & 6            & \cellcolor[HTML]{C0C0C0} & \cellcolor[HTML]{C0C0C0} & \cellcolor[HTML]{C0C0C0} & \cellcolor[HTML]{C0C0C0} \\ \hline
	\end{tabular}
\caption{X-point steady state error for a given JT60-SA scenario in the presence of a minor disruption. The XSC and  QST controller were used in different simulations for the shape control along  with two reconstruction methods for the LCFS. }
\end{table}
