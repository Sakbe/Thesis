...
\begin{figure}[htbp]
	...
	\caption{\label{Offset} Real-time subtraction from the integrated WO is performed on every MARTe cycle for each magnetic probe.  }
\end{figure}
...
\begin{figure}
	\begin{subfigure}[b]{0.47\textwidth}
		\includegraphics[trim={20.5cm 11.70cm 11.2cm 0},clip,height=4.55cm]{Chp4/Shot_44480.eps}  
...
\quad
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\includegraphics[trim={20.5cm 12.1cm 11.2cm 0},clip,height=4.55cm]{Chp4/Shot_44632.eps}        
