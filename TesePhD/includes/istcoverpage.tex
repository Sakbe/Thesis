...
{\FontXL \textbf{Stronzada con metallo liquido}} \\

\vspace{2cm}
{\FontM \textbf{Caterina Cavallini}} \\
\vspace{2cm}
{\FontS %
\begin{tabular}{l}
\textbf{Supervisors: Doctor Rui Barrocas Gomes} \\
\textbf{Doctor Alberto Ferro}\\
\textbf{Co-Supervisors: Doctor Italiano}\\
\end{tabular} } \\
\vspace{1.8cm}
{\FontM Thesis specifically prepared to obtain the Master Degree in} \\
\vspace{1.8mm}
{\FontL \textbf{Stronzada Engineering}} \\
\vspace{1.8cm}
{\FontM \textbf{Draft}} \\
\vspace{1.8cm}
{\FontM \textbf{November 2018}} \\
