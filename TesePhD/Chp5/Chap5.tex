...
This section presents the latest results from the real-time implementation of control algorithms in ISTTOK. In this section the vertical and horizontal plasma centroidInitial conditions , bumpless effect, inital conditions converge.\smallskip 
